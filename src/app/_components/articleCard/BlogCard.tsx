    ...
    <>
        <div className="w-full overflow-hidden">
            <div className="relative h-52 mb-8">
                ...
                <div className='absolute top-[100%] left-0 w-20 h-8 bg-[#49A760] text-[#fff] text-[14px] flex items-center justify-center'>Dec, 2024</div>
            </div>
            <div className="py-3">
                <h2 className="text-[24px] font-[500] mb-3 text-gray-800">Considered imprudence of technical friendship.</h2>
                <p className="text-[#525252] text-[16px]  mb-4 line-clamp-3">Vivamus accumsan diam eget ultricies auctor. Proin iaculis metus.</p>
                <Link href={"/news-articles/article"} className='flex items-start w-fit gap-2 hover:gap-4 transition-all duration-300 leading-[14px] text-[14px] text-[#009444]'>

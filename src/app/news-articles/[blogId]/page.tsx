      ...
      <div className="mx-auto max-w-[90%] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl my-20 md:my-32 space-y-20 lg:space-y-32">
        <div className='flex items-start gap-8 lg:gap-16'>
          <div className='w-full lg:w-2/3'>
            <div className='w-full relative'>
              <Image src={panner} alt='plog img' />
              <span className='absolute bottom-6 left-6 px-6 py-3 rounded-[10px] text-white bg-[#009444] text-[14px] font-[600]'>05 July 2024</span>
            </div>
            <div className='flex items-center gap-6 mb-3'>
              <div className='flex items-center gap-1'>
                ...
                <span className='text-[14px] text-[#878680] font-[500]'>by Kevin Martin</span>
              </div>
              <div className='flex items-center gap-1'>
                ...
                <span className='text-[14px] text-[#878680] font-[500]'>0 commentsh</span>
              </div>
            </div>
            <h2 className='text-[30px] text-[#1F1E17] font-[700] mb-4'>The Future of Farming, Smart Irrigation Solutions</h2>
            <p className='text-[16px] font-[500] leading-[30px] text-[#656565] mb-6'>Lorem ipsum dolor sit amet, cibo mundi ea duo, vim exerci phaedrum. There are many variations of
            ...
            <p className='text-[16px] font-[500] leading-[30px] text-[#656565] mb-6'>Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown
            ...
            <p className='text-[16px] font-[500] leading-[30px] text-[#656565] mb-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. orem Ipsum has been the
        ...
        <div>
          <div className='text-center mb-10'>
            ...
            <h2 data-aos="fade-zoom-in" data-aos-duration="500" data-aos-delay="0" className='text-[26px] md:text-[40px] text-[#252525] font-[500]'>Similar articles</h2>
          </div>

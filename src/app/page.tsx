...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className={styles.contactUs + ' py-32 grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto max-w-[90%] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl'}>
        <div className=''>
        ...
        <div className=' flex flex-col gap-8'>
          ...
          <h2 data-aos="fade-left" data-aos-duration="500" data-aos-delay="0" className='text-[40px] text-[#252525] font-bold pl-4'>Committed to <br />Sustainable Farming</h2>
      ...
      <div data-aos="flip-up" data-aos-duration="500" data-aos-delay="0" className='w-full mb-32'>
        <VideoPlayer
      ...
      <div className='py-16 mb-32 bg-[#F7FAF1]'>
